...
class Task
{
    ...
    {
        $GLOBALS['DB']->exec("INSERT INTO categories_tasks (category_id, task_id) VALUES ({$category->getId()},
        {$this->getId()});");
    }
    ...
    function update($new_description)
    {
        ...
        $GLOBALS['DB']->exec("UPDATE tasks SET description = '{$new_description}' WHERE is = {$this->getId()};");
